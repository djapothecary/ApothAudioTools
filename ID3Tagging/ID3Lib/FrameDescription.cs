...
{/// <summary>
 ...
 /// </summary>
    public static class FrameDescription
    {
        ...
        /// </summary>
        private static readonly Dictionary<string, string> Descriptions = Initialize();
        ...
        {
            string description;
            if (Descriptions.TryGetValue(frameId, out description))
            {
                return description;
            }
        ...
        private static Dictionary<string, string> Initialize()
        {
