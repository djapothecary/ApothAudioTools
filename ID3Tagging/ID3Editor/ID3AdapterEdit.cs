...
namespace ID3Tagging.ID3Editor
{
    public class ID3AdapterEdit : System.Windows.Forms.Form
    {
        ...
        private TabPage _tabPageLyrics;
        private TextBox _textBoxLyrics;
        private TabPage _tabPageMore;
        private Label _labelComposer;
        private TextBox _textBoxComposer;
        ...
        private TextBox _textBoxComments;
        ...
        /// </summary>
        private readonly Mp3File _mp3File = null;
        ...
        /// </summary>
        private readonly TagHandler _tagHandler = null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ID3AdapterEdit"/> class.
        /// </summary>
        /// <param name="mp3File">
        /// The mp 3 file.
        /// </param>
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTip1.SetToolTip(
                this._buttonScanWholeFile,
                "parse and count audio frames and bytes; result is added to details text box");
            ...
            this.checkBoxVbr.DataBindings.Add(
                new System.Windows.Forms.Binding("Checked", this._mp3FileBindingSource, "Audio.IsVbr", true));
            ...
            // _removePicture
            this._removePicture.Font = new System.Drawing.Font(
            ...
            this._artPictureBox.DataBindings.Add(
                new System.Windows.Forms.Binding("Image", this._tagHandlerBindingSource, "Picture", true));
            ...
            // _textBoxLength
            this._textBoxLength.DataBindings.Add(
                new System.Windows.Forms.Binding(
                    "Text",
                    this._tagHandlerBindingSource,
                    "Length",
                    true,
            ...
            // _textBoxPadding
            this._textBoxPadding.DataBindings.Add(
                new System.Windows.Forms.Binding(
                    "Text",
                    this._tagHandlerBindingSource,
                    "PaddingSize",
            ...
            this._textBoxComments.DataBindings.Add(
                new System.Windows.Forms.Binding("Text", this._tagHandlerBindingSource, "Comment", true));
            ...
            // _textBoxComposer
            this._textBoxComposer.DataBindings.Add(
                new System.Windows.Forms.Binding("Text", this._tagHandlerBindingSource, "Composer", true));
            ...
            this._errorProvider.DataMember = string.Empty;
        ...
        private void ID3Edit_Load(object sender, EventArgs e)
        {
            ...
            Binding bindSampleRate = new Binding(
                "Text",
                this._mp3FileBindingSource,
                "Audio.Header.SamplesPerSecond",
                true,
                System.Windows.Forms.DataSourceUpdateMode.Never);

            // Add the delegates to the events.
            bindSampleRate.Format += Bit_To_Kbit;
            ...
            Binding bindKBitRateCalc = new Binding(
                "Text",
                this._mp3FileBindingSource,
                "Audio.BitRateCalc",
                true,
            ...
            // Add the delegates to the events.
            bindKBitRateCalc.Format += Bit_To_Kbit;
            ...
            Binding bindKBitRateMP3 = new Binding(
                "Text",
                this._mp3FileBindingSource,
                "Audio.BitRateMp3",
                true,
            ...
            // Add the delegates to the events.
            bindKBitRateMP3.Format += Bit_To_Kbit;
            ...
            Binding bindKBitRateVbr = new Binding(
                "Text",
                this._mp3FileBindingSource,
                "Audio.BitRateVbr",
                true,
            ...
            // Add the delegates to the events.
            bindKBitRateVbr.Format += Bit_To_Kbit;
            ...
            Binding bindKBitRate = new Binding(
                "Text",
                this._mp3FileBindingSource,
                "Audio.BitRate",
                true,
            ...
            // Add the delegates to the events.
            bindKBitRate.Format += Bit_To_Kbit;
            ...
            Binding bindDetails = new Binding(
                "Text",
                this._mp3FileBindingSource,
                "Audio.DebugString",
                true,
            ...
            this.hasInconsistenciesCheckBox.DataBindings.Add(
                new System.Windows.Forms.Binding("CheckState", this._mp3FileBindingSource, "Audio.HasInconsistencies", true));
        }
        ...
        private static void Bit_To_Kbit(object sender, ConvertEventArgs cevent)
        {
            ...
            double rate = Convert.ToDouble(cevent.Value);
        ...
        private void SHA_Click(object sender, EventArgs e)
        {
            using (new CursorKeeper(Cursors.WaitCursor))
            {
                ...
                string txt = Convert.ToBase64String(sha1);
