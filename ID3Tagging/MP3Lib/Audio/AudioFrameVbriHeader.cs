...
namespace ID3Tagging.MP3Lib.Audio
{
    ...
    class AudioFrameVbriHeader : AudioFrame
    {
        ...
        ushort Version { get { return ParseBigEndianWORD(_frameBuffer, _headerBytes + 4); } }   // ....vv.. ........ ........ ........      
        // Delay as Big-Endian float
        ushort Delay { get { return ParseBigEndianWORD(_frameBuffer, _headerBytes + 6); } }   // ......dd ........ ........ ........      
        // Quality indicator
        ushort QualityIndicator { get { return ParseBigEndianWORD(_frameBuffer, _headerBytes + 8); } }   // ........ qq...... ........ ........
        // Number of Bytes in the audio stream as Big-Endian DWORD (including the VBRI header frame, and an extra one for luck?)
        uint VbriNumStreamBytes { get { return ParseBigEndianDWORD(_frameBuffer, _headerBytes + 10); } } // ........ ..bbbb.. ........ ........
        // Number of Frames in the audio stream  as Big-Endian DWORD (including the VBRI header frame, and an extra one for luck?)
        uint VbriNumStreamFrames { get { return ParseBigEndianDWORD(_frameBuffer, _headerBytes + 14); } } // ........ ......ff ff...... ........
        // Number of entries within TOC table as Big-Endian WORD
        ushort NumTocEntries { get { return ParseBigEndianWORD(_frameBuffer, _headerBytes + 18); } }  // ........ ........ ..tt.... ........
        // Scale factor of TOC table entries as Big-Endian DWORD
        ushort ScaleTocEntries { get { return ParseBigEndianWORD(_frameBuffer, _headerBytes + 20); } }  // ........ ........ ....ss.. ........
        // Size per table entry in bytes (max 4) as Big-Endian WORD
        ushort SizePerTocEntry { get { return ParseBigEndianWORD(_frameBuffer, _headerBytes + 22); } }  // ........ ........ ......zz ........   
        // Frames per table entry as Big-Endian WORD
        ushort FramesPerTocEntry { get { return ParseBigEndianWORD(_frameBuffer, _headerBytes + 24); } }  // ........ ........ ........ ff......   
        ...
        public override string DebugString
        {
            get
            {
                Trace.Assert(Header.FrameLengthInBytes != null, "Header.FrameLengthInBytes != null");
                ...
                Debug.Assert(overhang < 0, "toc end falls after Header.FrameLengthInBytes");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AudioFrameVbriHeader"/> class. 
