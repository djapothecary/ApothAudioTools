...
namespace Id3.Net.Id3v1
{
    internal sealed class Id3v1Handler : Id3Handler
    {
        ...
        //    {
        //        itemBytes = encoding.GetBytes(tag.Artists.Value);
        ...
        //    }
        //    if (!string.IsNullOrEmpty(tag.Year.Value))
        //    {
        //        itemBytes = encoding.GetBytes(tag.Year.Value);
        ...
        //        int maxCommentLength = tag.Track.AsInt == -1 ? 30 : 28;
        //        Array.Copy(itemBytes, 0, bytes, 97, Math.Min(maxCommentLength, itemBytes.Length));
        //    }
        //    if (tag.Track.AsInt >= 0)
        //        bytes[126] = (byte)tag.Track.AsInt;
        ...
        internal override Id3TagFamily Family
        {
            get
            {
                return Id3TagFamily.FileEndTag;
            }
        }
        ...
        internal override Type TagType
        {
            get
            {
                return typeof(Id3v1Tag);
            }
        }

        protected override void BuildFrameIdMappings(FrameIdMappings mappings)
        {
            mappings.Add<AlbumFrame>("Album");
            mappings.Add<ArtistsFrame>("Artist");
            mappings.Add<TitleFrame>("Title");
            mappings.Add<CommentFrame>("Comment");
            mappings.Add<TrackFrame>("Track");
            mappings.Add<YearFrame>("Year");
        }
