...
namespace ID3Tagging.MP3Lib.Audio
{
    ...
    public class AudioFrame
    {
        ...
        /// </param>
        /// <remarks>
        /// buffer is correct size, even for free bitrate files
        /// </remarks>
        ...
        /// size from header, or scanning for second frame of free bitrate file
        /// </param>
        ...
        public bool IsXingHeader
        {
            get
            {
                string _tag = Encoding.ASCII.GetString(_frameBuffer, (int)_headerBytes, 4);
